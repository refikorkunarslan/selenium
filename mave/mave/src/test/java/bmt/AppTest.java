...
public class AppTest
{
    public static void main( String[] args ) throws IOException, CsvException 
    {
      ...
      WebElement we=driver.findElement(By.xpath(" //*[@id=\"product-115346\"]/div/div[1]/div/div/div/div[2]/label"));
       ...
       String currentValueInString=driver.findElement(By.xpath(" //*[@id=\"cop-app\"]/div/div[1]/div[1]/div[2]/div/div[2]/div[2]/div[2]/div[2]")).getText();
    
        
       Assert.assertTrue(currentValueInString.charAt(0) == '-' );
